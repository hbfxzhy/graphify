...
**Step B2 - Dispatch ALL subagents in a single message (CatPaw)**

> **CatPaw platform:** Uses the **Agent (Task) tool** to dispatch subagents for parallel extraction.
> Each subagent runs independently and returns structured JSON results.
> CatPaw does NOT support PreToolUse hooks — AGENTS.md rules are the always-on mechanism instead.
